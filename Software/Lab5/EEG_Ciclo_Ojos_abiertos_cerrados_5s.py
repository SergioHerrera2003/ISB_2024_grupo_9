#PLOTEO SEÑAL EEG - Ciclos ojos abiertos - cerrados 5s cada uno
...
f = open("ciclo_ojos_abiertos_cerrados.txt","r")
...
array = np.genfromtxt("./ciclo_ojos_abiertos_cerrados.txt", skip_header = 2)
...
plt.grid(linestyle=":")
plt.title("EEG(uV)- Señal obtenida ciclo ojos abiertos y cerrados ")
plt.xlabel("Tiempo (s)")
plt.ylabel("EEG(uV)")
plt.legend(loc="upper right")
plt.xlim([0,25])
