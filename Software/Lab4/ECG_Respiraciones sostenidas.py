#PLOTEO SEÑAL ECG LUEGO DE RESPIRACIONES SOSTENIDAS
...
f = open("ECG_respiraciones_sostenidas.txt","r")
...
array = np.genfromtxt("./ECG_respiraciones_sostenidas.txt", skip_header = 2)
...
plt.grid(linestyle=":")
plt.title("ECG - Después de respiraciones sostenidas")
plt.xlabel("Tiempo (s)")
