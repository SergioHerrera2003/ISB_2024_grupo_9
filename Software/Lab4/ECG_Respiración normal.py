#PLOTEO SEÑAL ECG REPOSO - RESPIRACIÓN NORMAL
...
f = open("ECG_respiracion_normal.txt","r")
...
array = np.genfromtxt("./ECG_respiracion_normal.txt", skip_header = 2)
...
plt.grid(linestyle=":")
plt.title("ECG - Respiración normal")
plt.xlabel("Tiempo (s)")
